...
from deep_research_agents.prompts import research_agent_prompt, compress_research_system_prompt, compress_research_human_message
...
compress_model = get_model("compress")
