...
from deep_research_agents.research_agent_scope import clarify_with_user, write_research_brief
from deep_research_agents.multi_agent_supervisor import supervisor_agent

# ===== Config =====

writer_model = get_model("report")
