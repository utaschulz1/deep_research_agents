...
max_researcher_iterations = get_settings().max_researcher_iterations # Calls to think_tool + ConductResearch

# Maximum number of concurrent research agents the supervisor can launch
# This is passed to the lead_researcher_prompt to limit parallel research tasks
max_concurrent_researchers = get_settings().max_concurrent_researchers
...
async def supervisor_tools(state: SupervisorState) -> Command[Literal["supervisor", "__end__"]]:
    ...
    if exceeded_iterations or no_tool_calls or research_complete:
        ...
        # KNOWN BUG (ported verbatim, not fixed — see federated-hopping-walrus.md plan,
        # "Surfacing (not fixing) the supervisor's silent-failure bug"): any exception here
